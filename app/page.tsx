...
export default function Home() {
  return (
    <>
      ...
      {/* Section 1: Hero */}
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-[#1a4d2e] to-[#0d2617] pt-16">
        <div className="absolute inset-0 bg-black/50 z-0" />
        <div className="relative z-10 text-center px-4 sm:px-6 lg:px-8 max-w-4xl mx-auto">
          <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-[#f5f5f1] mb-6 leading-tight">
            Protecting Kerala&rsquo;s Environment, One Action at a Time.
          </h1>
          <p className="text-lg sm:text-xl text-[#f5f5f1]/90 mb-8 max-w-2xl mx-auto">
          ...
          <div className="mt-12 text-sm text-[#f5f5f1]/60">
      ...
      <SectionContainer id="what-we-do" className="bg-[#1a1a1a]">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#f5f5f1] mb-4">
            What We Do
          </h2>
      ...
      <SectionContainer className="bg-[#2a2a2a]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="text-center">
            <div className="text-4xl font-bold text-[#5fa86a] mb-2">50+ tons</div>
            <h3 className="text-xl font-semibold text-[#f5f5f1] mb-2">Plastic Pollution</h3>
            <p className="text-[#f5f5f1]/70">
              Removed annually from Kerala&rsquo;s rivers and coastlines
            </p>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-[#5fa86a] mb-2">2,000+</div>
            <h3 className="text-xl font-semibold text-[#f5f5f1] mb-2">Saplings Planted</h3>
            <p className="text-[#f5f5f1]/70">
              Combating deforestation and habitat loss across the state
            </p>
          </div>
          <div className="text-center">
            <div className="text-4xl font-bold text-[#5fa86a] mb-2">5M+</div>
            <h3 className="text-xl font-semibold text-[#f5f5f1] mb-2">Residents at Risk</h3>
            <p className="text-[#f5f5f1]/70">
      ...
      <SectionContainer id="our-impact" className="bg-[#1a1a1a]">
        <div className="text-center mb-12">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#f5f5f1] mb-4">
            Our Impact
          </h2>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          <div className="text-center">
            <div className="text-5xl font-bold text-[#5fa86a] mb-2">5,000+</div>
            <p className="text-[#f5f5f1]/80 font-medium">Volunteers Mobilized</p>
          </div>
          <div className="text-center">
            <div className="text-5xl font-bold text-[#5fa86a] mb-2">120+</div>
            <p className="text-[#f5f5f1]/80 font-medium">Cleanup Drives Executed</p>
          </div>
          <div className="text-center">
            <div className="text-5xl font-bold text-[#5fa86a] mb-2">18</div>
            <p className="text-[#f5f5f1]/80 font-medium">Districts Covered</p>
          </div>
          <div className="text-center">
            <div className="text-5xl font-bold text-[#5fa86a] mb-2">50,000+</div>
            <p className="text-[#f5f5f1]/80 font-medium">Saplings Planted</p>
          </div>
        </div>
      </SectionContainer>
      ...
      <SectionContainer className="bg-[#1a1a1a]">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="text-center">
            <div className="w-16 h-16 bg-[#1a4d2e] rounded-full flex items-center justify-center text-3xl font-bold text-[#5fa86a] mx-auto mb-4">
              1
            </div>
            <h3 className="text-xl font-semibold text-[#f5f5f1] mb-2">Sign Up</h3>
            <p className="text-[#f5f5f1]/70">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-[#f5f5f1] mb-2">Choose Cause</h3>
            <p className="text-[#f5f5f1]/70">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-[#f5f5f1] mb-2">Attend Drive</h3>
            <p className="text-[#f5f5f1]/70">
          ...
          <div className="text-center">
            ...
            <h3 className="text-xl font-semibold text-[#f5f5f1] mb-2">Lead Locally</h3>
            <p className="text-[#f5f5f1]/70">
      ...
      <SectionContainer className="bg-gradient-to-br from-[#1a4d2e] to-[#0d2617]">
        <div className="text-center max-w-3xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-bold text-[#f5f5f1] mb-6">
            Partner With Us
          </h2>
